...
def main():
    ...
    with sync_playwright() as p:
        ...
        def handle_response(response):
            ...
            if (
                ...
                if response.url not in found_urls:
                    ...
                    print(
                        f"Eurostar M3U8 yanıtı bulundu: "
                        f"{response.url}",
                        file=sys.stderr
                    )
        ...
        try:
            ...
            # Sayfadaki video elementlerini kontrol et
            page.wait_for_timeout(5000)

            # Varsa video elementini oynatmayı dene
            try:
            ...
            # Yayın isteğinin oluşması için bekle
    ...
    # SADECE M3U8 URL'sini stdout'a yazdır.
    # GitHub Actions bunu estar.m3u8 dosyasına kaydedecek.
    print(best_url)
